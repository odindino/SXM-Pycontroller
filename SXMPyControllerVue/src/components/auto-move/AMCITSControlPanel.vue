  ...
  <div class="bg-white p-6 rounded-lg shadow">
    ...
    <div class="space-y-6">
      ...
      <div class="grid grid-cols-2 gap-4">
        <button
          @click="$emit('start-auto-move-ssts')"
          :disabled="isRunning"
          class="px-4 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 
        ...
        <button
          @click="$emit('start-auto-move-msts')"
          :disabled="isRunning || !selectedScript"
          class="px-4 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 
...
defineEmits([
  ...
  'select-script',
  'refresh-scripts',
  'start-auto-move-ssts',
  'start-auto-move-msts'
])
</script>